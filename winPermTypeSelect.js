...
function winPermTypeSelect (o) {
	lg('winPermTypeSelect');
	...
	this.store1 = Ext.create('Ext.data.BufferedStore', {
		...
		autoLoad:false,
		proxy:{
			type:'allshippersPermsTypesAPI', url:'api.php', noCache:false, simpleSortMode:true, sortParam:'sort', groupDirectionParam:'dir', startParam:'start', limitParam:'limit',
			reader: {type:'json', rootProperty:'data', totalProperty:'total'},
		},
		sorters:[{property:'perm', direction:'ASC'}],
	...
	var opt = {
		title:o.title, maximized:false, maximizable:true, minimizable:false, monitorResize:true, closable:true, width:320, height:360, resizable:true, modal:true, padding:3, bodyPadding:0, layout:'fit',

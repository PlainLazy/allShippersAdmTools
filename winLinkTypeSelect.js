...
function winLinkTypeSelect (o) {
	lg('winLinkTypeSelect');
	...
	this.store1 = Ext.create('Ext.data.BufferedStore', {
		...
		autoLoad:false,
		proxy:{
			type:'allshippersLinksTypesAPI', url:'api.php', noCache:false, simpleSortMode:true, sortParam:'sort', groupDirectionParam:'dir', startParam:'start', limitParam:'limit',
			//extraParams:exPars,
